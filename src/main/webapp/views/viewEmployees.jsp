     ...
     <a href="addUser" class="add-btn">
        ...
        <tr>
            ...
            <td><%= user.getUserName() %></td>
             ...
             <td>
             <a href="ViewPosts?userId=<%= user.getUserId() %>" class="btn-edit">
             view Posts
             </a>
             </td>
              <td>
            ...
            <%
              Integer loginUserId = (Integer) request.getAttribute("loginUserId");
                         if (loginUserId != null && loginUserId == user.getUserId()) {
             ...
             <div style="display:flex;">
                ...
                <form action="removeemployee">
                 ...
                 <a href="Addposts?userId=<%= user.getUserId() %>" class="btn-edit">
                                     AddPosts
                              </a>
                 </div>
                 <%
